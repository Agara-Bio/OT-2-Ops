...
def run(ctx):
    ...
    [number_of_samples, dna_volume, mastermix_volume, master_mix_csv,
     tuberack_type, single_channel_type, single_channel_mount,
    ...
    p1 = ctx.load_instrument(single_channel_type, single_channel_mount, tip_racks=tipracks1)
    tipracks2 = ctx.load_labware('opentrons_96_tiprack_300_ul', 9)
    p1 = ctx.load_instrument(pipette_2_type, pipette_2_mount, tip_racks=tipracks2)
